...
<template>
  <div class="max-w-3xl mx-auto">
    <header class="mb-8 border-b border-gray-300 pb-4">
        <h1 class="text-3xl font-light text-gray-900">Add New Movie</h1>
    </header>

    <form @submit.prevent="createMovie" class="space-y-6 bg-white p-8 border border-gray-200 shadow-sm">
